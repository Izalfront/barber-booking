...
<div class="mx-6 pt-6">
	<div class="relative overflow-hidden" style="width: 100%; height: 300px;">
		...
		<button
			class="absolute top-[0rem] left-[19.5rem] bg-[#27AE60] px-4 py-2.5 rounded-bl-xl text-white font-semibold"
			><div class="flex gap-x-1">Open</div>
		</button>
	</div>
	...
	<div class="block mt-4">
		...
		<div class="flex items-center">
			...
			<p class="text-[#8683A1]">Joga Expo Centre (2 km)</p>
		</div>
		<div class="flex items-center">
			<svg
				width="15"

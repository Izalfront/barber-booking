<script lang="ts">
	...
	function handleStarHover(hoveredValue: number) {
		hoveredRating = hoveredValue;
	}
...
<div class="mb-6">
	<h1 class="text-xl font-semibold text-black mb-3">Rating Barber</h1>
	<div class="flex items-center gap-1">
				...
				>
					...
					>
						<path
							...
							fill={i + 1 <= (hoveredRating || rating) ? '#FFB800' : '#8683A1'}
		...
		<span class="text-gray-600 ml-2">({rating}.0)</span>
	</div>
</div>
